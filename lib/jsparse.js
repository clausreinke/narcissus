...
Narcissus.parser = (function() {
    ...
    /*
     * getPosition :: tokenizer -> string
     *
     * returns current source position as 'line:column'
     *
     * TODO: - should there be a columnno tokenizer method?
     */
    function getPosition(t) {
        var column = t.cursor-t.lineStart+1;
        return t.lineno+':'+column;
    }
    ...
    function FunctionDefinition(t, x, requireName, functionForm, comments) {
        ...
        // node where f's name is in scope
        f.context = functionForm === DECLARED_FORM ? x.parentScript : f;

        f.end    = t.token.end;
        f.endPos = getPosition(t);
